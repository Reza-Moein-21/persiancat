...
public final class HttpRequestParserException extends CattyException {
    ...
    public static final HttpRequestParserException INVALID_HEADER_FORMAT = HttpRequestParserException.ofHttpStatus(HttpStatus.BAD_REQUEST, "Header format is not valid");
